...
const Play = () => {
  ...
  React.useEffect(() => {
    console.log("Play UseEffect", ctx.playOption.duration);
    audioPlayer.current.pause();
    setIsPlaying(false);
    switch (ctx.playOption.duration) {
      case "5mins":
  ...
  function progressBarClickToNavigate(ev) {
    ...
    <div className="app-container w-full h-full p-[32px] body-font font-poppins flex flex-col justify-between">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between mx-[53px] mt-[17px]">
          ...
          <Link className=" hover:cursor-pointer" id="setting" to="/setting">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
